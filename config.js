...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Nzi-Bot",
    footer: process.env.Footer || "© Powered by Mark",
     ...
     */
    ownername: process.env.Owner_Name || "Mark",
    ownernumber: process.env.Owner_Number || "254736429306",
    ...
    sessionId: process.env.SESSION_ID || "MThoMzJ_Queen-Anya_0ODQ=",

    /**
     * thumbnails and medias
     */
    image_1: readFileSync('./llib/Assets/Screenshot_20240919_190110_CapCut.jpg'), // primary image
    image_2: readFileSync('./lib/Assets/Screenshot_20240919_190110_CapCut.jpg'), // secondry image
    ...
    message: {
        ...
        admin: "*👤 A𝙳𝙼𝙸𝙽 N𝙴𝙴𝙳𝙴𝙳!*\n\n- Mark says this command is only for Admins. You have to be a admin in this group to use this command.",
        botAdmin: "*🤖 B𝙾𝚃 A𝙳𝙼𝙸𝙽 N𝙴𝙴𝙳𝙴𝙳!*\n\n- I'm not an Admin, so I can't execute this command in this group. Please make me an Admin.",
        owner: "*👑 O𝚆𝙽𝙴𝚁 N𝙴𝙴𝙴𝙳𝙴𝙳!*\n\n- Mark says, this command is only made for this bot's owner. So you can't use this command.",
        group: "*👥 G𝚛𝚘𝚞𝚙 N𝚎𝚎𝚍𝚎𝚍!*\n\n- Mark says This command can only be executed in a group chat.",
        private: 'Mark says command is only for private chats.',
        wait: '🔄 Processing request...',
        error: "❌ Oops! An error occurred while processing your request. Please try again later.",
        ban: `You're banned from using this bot!`,
        nsfw: 'This group is not *NSFW* enabled.',
        banChat: 'This group is banned from using this bot, please contact Mark to get unbanned.'
    },
